...
public interface IHotelServiceReservation {
    ...
    @RequestWrapper(localName = "reservationValide", targetNamespace = "http://services.service.web.hotel/", className = "agence.web.service.client.ReservationValide")
    @ResponseWrapper(localName = "reservationValideResponse", targetNamespace = "http://services.service.web.hotel/", className = "agence.web.service.client.ReservationValideResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getReference", targetNamespace = "http://services.service.web.hotel/", className = "agence.web.service.client.GetReference")
    @ResponseWrapper(localName = "getReferenceResponse", targetNamespace = "http://services.service.web.hotel/", className = "agence.web.service.client.GetReferenceResponse")
