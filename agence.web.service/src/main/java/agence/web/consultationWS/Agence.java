...
public class Agence {
    ...
    protected ArrayList<Hotel> hotelsPartenaires; 

    public Agence() {
    	
    }
    
    public Agence(int i, String string, String string2, ArrayList<Hotel> hotelsPAgence1) {
		identifiant = i;
		login = string;
		motdepasse = string2;
		hotelsPartenaires = hotelsPAgence1;
	}
